...
export const members = [
  ...
  { id: 2,  name: 'Michelle Nocalan',        voicePart: 'Soprano', email: 'michelle.nocalan@email.com',         phone: '09171234002', status: 'active',   attendanceRate: 89, present: 15, late: 1, absent: 2, excused: 0, joinedDate: '2023-08-01', address: 'Carmen, Bohol' },
  { id: 3,  name: 'Villa Mae Cajes',      voicePart: 'Soprano', email: 'villa.cajes@email.com',       phone: '09171234003', status: 'active',   attendanceRate: 100, present: 18, late: 0, absent: 0, excused: 0, joinedDate: '2024-01-08', address: 'Tagbilaran City' },
  { id: 4,  name: 'Geraldine Timario',  voicePart: 'Soprano', email: 'geraldine.timario@email.com',   phone: '09171234004', status: 'inactive', attendanceRate: 72, present: 13, late: 0, absent: 5, excused: 0, joinedDate: '2023-08-01', address: 'Ubay, Bohol' },
  { id: 5,  name: 'Catherine Terce',     voicePart: 'Alto',    email: 'catherine.terce@email.com',     phone: '09181234005', status: 'active',   attendanceRate: 83, present: 14, late: 1, absent: 3, excused: 0, joinedDate: '2023-08-01', address: 'Trinidad, Bohol' },
  { id: 6,  name: 'Loi Benisse Trago',     voicePart: 'Alto',    email: 'loi.trago@email.com',     phone: '09181234006', status: 'active',   attendanceRate: 94, present: 17, late: 0, absent: 1, excused: 0, joinedDate: '2024-08-05', address: 'Talibon, Bohol' },
  { id: 7,  name: 'Lyca Lajato',    voicePart: 'Alto',    email: 'lyca.lajato@email.com',     phone: '09181234007', status: 'active',   attendanceRate: 78, present: 13, late: 2, absent: 3, excused: 0, joinedDate: '2023-08-01', address: 'Bien Unido, Bohol' },
  { id: 8,  name: 'Lhorrmae De Castro',   voicePart: 'Alto',    email: 'lhorrmae.decastro@email.com',   phone: '09181234008', status: 'active',   attendanceRate: 89, present: 16, late: 0, absent: 2, excused: 0, joinedDate: '2024-01-08', address: 'Jetafe, Bohol' },
  { id: 9,  name: 'Mica Omolon',      voicePart: 'Alto',   email: 'mica.omolon@email.com',       phone: '09191234009', status: 'active',   attendanceRate: 94, present: 17, late: 0, absent: 1, excused: 0, joinedDate: '2023-08-01', address: 'Trinidad, Bohol' },
  { id: 10, name: 'Kenndey Saberon',    voicePart: 'Tenor',   email: 'kenndey.saberon@email.com',     phone: '09191234010', status: 'active',   attendanceRate: 83, present: 14, late: 1, absent: 3, excused: 0, joinedDate: '2024-08-05', address: 'Sierra Bullones, Bohol' },
  { id: 11, name: 'John Lee Ranque',       voicePart: 'Tenor',   email: 'john.ranque@email.com',       phone: '09191234011', status: 'active',   attendanceRate: 72, present: 12, late: 1, absent: 5, excused: 0, joinedDate: '2023-08-01', address: 'Candijay, Bohol' },
  { id: 12, name: 'Evander Legaspi',      voicePart: 'Tenor',   email: 'evander.legaspi@email.com',       phone: '09191234012', status: 'inactive', attendanceRate: 61, present: 11, late: 0, absent: 7, excused: 0, joinedDate: '2023-08-01', address: 'Mabini, Bohol' },
  { id: 13, name: 'Ian Borja',     voicePart: 'Tenor',    email: 'ian.borja@email.com',     phone: '09201234013', status: 'active',   attendanceRate: 100, present: 18, late: 0, absent: 0, excused: 0, joinedDate: '2023-08-01', address: 'Trinidad, Bohol' },
  { id: 14, name: 'Kim Gerald',       voicePart: 'Tenor',    email: 'kim.gerald@email.com',       phone: '09201234014', status: 'active',   attendanceRate: 89, present: 16, late: 0, absent: 2, excused: 0, joinedDate: '2024-01-08', address: 'Dagohoy, Bohol' },
  { id: 15, name: 'Marquee Gabisan',       voicePart: 'Bass',    email: 'marquee.gabisan@email.com',       phone: '09201234015', status: 'active',   attendanceRate: 78, present: 14, late: 0, absent: 4, excused: 0, joinedDate: '2024-08-05', address: 'Danao, Bohol' },
  { id: 16, name: 'Earl Francis Cao',        voicePart: 'Bass',    email: 'earl.cao@email.com',         phone: '09201234016', status: 'active',   attendanceRate: 83, present: 14, late: 1, absent: 3, excused: 0, joinedDate: '2023-08-01', address: 'Trinidad, Bohol' },
  { id: 17, name: 'Kristopher Jay Garcia',        voicePart: 'Bass',    email: 'kristopher.garcia@email.com',         phone: '09201234018', status: 'active',   attendanceRate: 83, present: 14, late: 1, absent: 3, excused: 0, joinedDate: '2023-08-01', address: 'Trinidad, Bohol' },
  { id: 18, name: 'John Rey Hoylar',        voicePart: 'Bass',    email: 'john.hoylar@email.com',         phone: '09201234019', status: 'active',   attendanceRate: 83, present: 14, late: 1, absent: 3, excused: 0, joinedDate: '2023-08-01', address: 'Trinidad, Bohol' },
  { id: 19, name: 'Julius Bardos',        voicePart: 'Bass',    email: 'julius.bardos@email.com',         phone: '09201234021', status: 'active',   attendanceRate: 83, present: 14, late: 1, absent: 3, excused: 0, joinedDate: '2023-08-01', address: 'Trinidad, Bohol' },
