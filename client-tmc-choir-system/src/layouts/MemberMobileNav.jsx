...
export default function MemberMobileNav() {
  return (
    <nav className="grid h-16 grid-cols-3 border-t border-slate-200/50 bg-white/95 px-1 backdrop-blur md:hidden z-20 shrink-0 dark:border-slate-800/70 dark:bg-slate-950/95">
